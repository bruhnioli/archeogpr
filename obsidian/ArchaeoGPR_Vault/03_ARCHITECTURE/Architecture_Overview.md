...
- **E — Future Processing Pipeline**: **Sprint 1'de implemente edilmemiştir.** Zaman-sıfırı düzeltmesi, DC ofset, dewow, band-pass, arka plan çıkarma, kazanç (gain), F-K filtreleme, migrasyon gibi sinyal işleme adımlarının planlandığı ama henüz hiçbir kodu yazılmamış katman. Bkz. [[Processing_Pipeline_Architecture]] ve [[Processing_Index]].
